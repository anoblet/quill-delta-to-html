...
var ListNester = (function () {
    ...
    ListNester.prototype.nest = function (groups) {
        ...
        var nested = flatten(groupedByListGroups.map(function (group) {
            if (!Array.isArray(group)) {
                return group;
            }
            return _this.nestListSection(group);
        }));
        var groupRootLists = groupConsecutiveElementsWhile(nested, function (curr, prev) {
    ...
    ListNester.prototype.convertListBlocksToListGroups = function (items) {
        ...
        return grouped.map(function (item) {
            ...
            return new ListGroup(item.map(function (g) { return new ListItem(g); }));
        });
    };
    ListNester.prototype.groupConsecutiveListGroups = function (items) {
        return groupConsecutiveElementsWhile(items, function (curr, prev) {
