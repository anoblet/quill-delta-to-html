...
var OpAttributeSanitizer = (function () {
    ...
    OpAttributeSanitizer.sanitize = function (dirtyAttrs, sanitizeOptions) {
        ...
        if (find([AlignType.Center, AlignType.Right, AlignType.Justify, AlignType.Left], function (a) { return a === align; })) {
        ...
        if (mentions && mention) {
            var sanitizedMention = MentionSanitizer.sanitize(mention, sanitizeOptions);
